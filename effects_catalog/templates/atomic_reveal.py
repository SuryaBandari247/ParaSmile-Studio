...
class {SCENE_CLASS}(Scene):
    ...
    def construct(self):
        ...
        entity_box = RoundedRectangle(
            ...
            color="#2962FF", fill_color="#1E293B", fill_opacity=0.9,
            stroke_width=2,
        )
        entity_label = Text(entity_name, font=FONT, font_size=44, color="#F8FAFC", weight=BOLD)
        ...
        for i, comp in enumerate(components):
            ...
            box = RoundedRectangle(
                ...
                color=color, fill_color="#1E293B", fill_opacity=0.85,
                stroke_width=1.5,
            )
            name_text = Text(name, font=FONT, font_size=18, color="#F8FAFC")
