"""Liquidity Shock Effect — shockwave pulse at a crash/event date.

Editorial-layout timeseries with vertical energy pulse, multi-layer glow,
news-style shock annotation, and narrative ending overlay.
"""
...
SCENE_CLASS = "LiquidityShockScene"
